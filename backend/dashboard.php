...
<style>
  ...
  @media(max-width:1050px){.dashboard-grid{grid-template-columns:1fr}}@media(max-width:650px){main{padding:18px 14px}.admin-card{padding:16px;border-radius:18px}.welcome-card{min-height:120px;padding:20px}.welcome-card:after{right:14px;font-size:48px}.card-head{align-items:flex-start}.card-head h2{font-size:18px}.filter-row{display:grid;grid-template-columns:1fr 1fr}.filter-row select{width:100%;min-width:0}.stat-box p{font-size:27px}.warning-list li{padding:10px 10px 10px 58px;display:block}.warning-list .product-thumb{top:10px}.stock-badge{position:static;display:inline-flex;margin-top:5px}.mini-stats{grid-template-columns:1fr 1fr}.table-scroll{border:0;overflow:visible}.dashboard-table{min-width:0;display:block}.dashboard-table thead{display:none}.dashboard-table,.dashboard-table tbody,.dashboard-table tr{display:block}.dashboard-table tr{margin-bottom:12px;padding:14px;border:1px solid var(--line);border-radius:16px;background:#fff}.dashboard-table td{display:flex;justify-content:space-between;align-items:center;gap:12px;padding:7px 0;border:0;text-align:right!important}.dashboard-table td:before{content:attr(data-label);color:var(--muted);font-size:12px;font-weight:600}.dashboard-table td.product-data{display:block;text-align:left!important;padding-bottom:10px;border-bottom:1px solid var(--line)}.dashboard-table td.product-data:before{display:none}.product-cell{min-width:0}.dashboard-table td.rank-data{position:absolute;margin:7px 0 0 calc(100% - 78px);width:28px;height:28px;display:grid;place-items:center;padding:0;border-radius:50%;background:#f4dfc7}.dashboard-table td.rank-data:before{display:none}}
  ...
  @media(max-width:650px){.dashboard-table tr{position:relative}.dashboard-table td.rank-data{position:absolute!important;right:12px;top:12px;margin:0!important}.dashboard-table td.product-data{padding-right:42px}.sales-card #salesChart{height:145px!important;max-height:145px}}
</style>
</head>
